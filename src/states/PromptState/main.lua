...
function PromptState:enter(params)
	self.msg=params.msg or "Tem certeza de que deseja sair?"
...
function PromptState:renderText()
    ...
    love.graphics.print("Sim",self.x+50,self.y+self.height-38)
    love.graphics.print("Não",self.x+self.width-90,self.y+self.height-38)
end