local function drawGreenBackground()
	-- 6 == math.ceil(VIRTUAL_HEIGHT/128) quando VIRTUAL_HEIGHT = 720
...
-- como sempre desenhamos apenas um sprite com dois quads diferentes, faz sentido ter
-- duas funções de desenho customizadas para desenhar cada um dos quads
